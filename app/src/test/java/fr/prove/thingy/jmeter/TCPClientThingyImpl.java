package fr.prove.thingy.jmeter;
 ...
 *
 * /**
 * @file fr.prove.thingy.fr.prove.thingy.jmeter.TCPClientThingyImpl.java
 * @brief Classe du client TCP à utiliser avec JMeter pour tester Thingy.
 * @version 1.0
 * @date 29/04/2016
 * @author Matthias Brun, Clarisse Girault
 * @copyright cf:/se2017-equipea2/qualite/modeles : « License_BSD »
 * @see org.apache.jmeter.protocol.tcp.sampler.TCPClient
 *  *
 */

public class TCPClientThingyImpl implements TCPClient {
        ...
        /**
        * Le caractère de précédant la fin-de-ligne/fin-de-message (end-of-line/end-of-message).
        */

        private byte eol2Byte = (byte) '\r';


        /**
         * Constructeur d'un client TCP à utiliser avec JMeter.
         */
        public TCPClientThingyImpl()
        {
            super();
        }
        ...
        public String read(InputStream is)
        {
            ...
            try {
                ...
                System.out.print("[info] TCPClientThingy : Interruption d'expiration sur le flux ");
        ...
        /**
         * Donne le caractère précédant la fin-de-ligne/fin-de-message (end-of-line/end-of-message).
         *
         * @return le caractère eol2Byte.
         */

        public byte getEol2Byte()
        {
            return this.eol2Byte;
        }



        /**
         * Fixe le caractère précédant la fin-de-ligne/fin-de-message (end-of-line/end-of-message).
         *
         * @param eol2Byte le caractère à fixer.
         */

        public void setEol2Byte(int eol2Byte)
        {
            this.eol2Byte = (byte) eol2Byte;
        }
